...
const {courseInstructor : Instructor} = course;  // another way of destructring the objects

console.log(Instructor);  // here we are getting the courseInstructor attribute of course object as a name of Instructor.